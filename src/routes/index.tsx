    ...
    <div className={'min-h-screen bg-gray-50 p-8'}>
      <div className={'max-w-4xl mx-auto'}>
        ...
        <div className={'grid grid-cols-1 md:grid-cols-3 gap-6'}>
          <a className={'block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow'} href={'/exercises'}>
          ...
          <a className={'block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow'} href={'/templates'}>
            <h2 className={'text-xl font-semibold text-gray-900 mb-2'}>{'Templates'}</h2>
            <p className={'text-gray-600'}>{'Create workout templates'}</p>
          </a>

          <a className={'block p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow'} href={'/workouts/new'}>

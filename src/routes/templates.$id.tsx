...
import { ArrowLeft, Copy, Edit, Trash2, Dumbbell } from 'lucide-react';
    ...
    async function fetchTemplate() {
      ...
      try {
        ...
        if (exercisesResponse.ok) {
          const exercisesData = await exercisesResponse.json() as TemplateExercise[];
      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <a href="/templates" className="text-blue-600 hover:text-blue-500">
              ← Back to Templates
            </a>
          </div>
        </div>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        {te.exercise?.muscleGroup && (
                          <p className="text-sm text-gray-500">{te.exercise.muscleGroup}</p>
                        )}
                      </div>
                    </div>
                  ))}
